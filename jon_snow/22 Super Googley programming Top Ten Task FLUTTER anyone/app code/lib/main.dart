              ...
              child: Stack(
                ...
                children: <Widget>[
                  _buildArrow(Alignment.centerRight, Icons.arrow_forward,
                      "Going forward"),
                  _buildArrow(Alignment.centerLeft, Icons.arrow_back,
                      "Going back"),
                  _buildArrow(Alignment.bottomCenter, Icons.arrow_downward,
                      "Going down"),
                  _buildArrow(Alignment.topCenter, Icons.arrow_upward,
                      "Going up"),
                ],
              ),
            ),
